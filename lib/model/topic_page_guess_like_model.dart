...
class TopicGuessLikeData {

  int code;
  String message;
  List<Data> data;

  TopicGuessLikeData.fromParams({this.code, this.message, this.data});

  factory TopicGuessLikeData(jsonStr) => jsonStr == null ? null : jsonStr is String ? new TopicGuessLikeData.fromJson(json.decode(jsonStr)) : new TopicGuessLikeData.fromJson(jsonStr);

  TopicGuessLikeData.fromJson(jsonRes) {
    code = jsonRes['code'];
